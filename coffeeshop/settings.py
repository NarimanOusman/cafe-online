...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-13+n#-7qe-z&!n63c)011+)m2#8r1c+!7z@n7r3%m8mq0_&882')
...
# Media files
MEDIA_URL = '/media/'
# MEDIA_ROOT = os.path.join(BASE_DIR, 'media')  # ← Comment this out when using Cloudinary
